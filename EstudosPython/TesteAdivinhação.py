...
def teste_adivinhacao():
    ...
    print("Niveis de Dificuldade: (1) Facil (2) Médio (3) Difícil", numero_secreto)
    ...
    while (rodada <= total_de_tentativas):
        ...
        if (acertou):
            print("Você acertou, Voce tem {} pontos".format(pontos))
            break
        else:
            if (maior):
...
if(__name__ == "__main__"): # Caso eu queria executar essa função sozinha sem precisar de arquivo TesteImportaçãoDeOutrosArquivos.py
    teste_adivinhacao()